...
class __TwigTemplate_d9d0d50865ce6f3a1487100c2ba9c546d44540e8c9f7937c0e444a30d17908f2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"phpdocumentor-row\">
        ...
        if ( !twig_test_empty(($context["filesWithMarkers"] ?? null))) {
            ...
            $context['_seq'] = twig_ensure_traversable(twig_array_filter(twig_get_attribute($this->env, $this->source, ($context["project"] ?? null), "files", [], "any", false, false, false, 20), function ($__file__) use ($context, $macros) { $context["file"] = $__file__; return  !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["file"], "allErrors", [], "any", false, false, false, 20)); }));
            foreach ($context['_seq'] as $context["_key"] => $context["file"]) {
                // line 21
                echo "                    ";
                if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["file"], "allerrors", [], "any", false, false, false, 21), "count", [], "any", false, false, false, 21) > 0)) {
                    // line 22
                    echo "                        <tr>
                    ...
                    // line 24
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["file"], "allErrors", [], "any", false, false, false, 24), "count", [], "any", false, false, false, 24), "html", null, true);
                    echo "</td>
                        </tr>
                    ";
                }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["file"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
                ...
                echo "                    <tr>
                        <td class=\"phpdocumentor-cell\">";
                // line 49
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["marker"] ?? null), "type", [], "any", false, false, false, 49), "html", null, true);
                echo "</td>
                        <td class=\"phpdocumentor-cell\">";
                // line 50
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["marker"] ?? null), "line", [], "any", false, false, false, 50), "html", null, true);
                echo "</td>
                        <td class=\"phpdocumentor-cell\">";
                // line 51
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["markers"] ?? null), "message", [], "any", false, false, false, 51), "html", null, true);
                echo "</td>
                    </tr>
                ";
            }
